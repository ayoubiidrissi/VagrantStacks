...
install_replication_master(){
  ...
  echo "host    all           xavki           192.168.12.0/24         md5" | tee -a /etc/postgresql/*/main/pg_hba.conf
...
#create_objects(){
#  sudo -u postgres psql -c "CREATE ROLE xavki LOGIN ENCRYPTED PASSWORD 'password';"  
#  sudo -u postgres psql -c "CREATE DATABASE db_ha;"
#  sudo -u postgres psql -d db_ha -c "CREATE SCHEMA sch_ha;"
#  sudo -u postgres psql -c "GRANT CONNECT ON DATABASE db_ha TO xavki;"
#  sudo -u postgres psql -c "GRANT CONNECT ON DATABASE db_ha TO replication;"
#  sudo -u postgres psql -c "GRANT USAGE ON SCHEMA sch_ha TO xavki;"
...
#  sudo -u postgres psql -c "GRANT ALL PRIVILEGES ON DATABASE db_ha TO xavki;"
#  sudo -u postgres psql -d db_ha -c "GRANT ALL PRIVILEGES ON ALL TABLES IN SCHEMA sch_ha TO xavki;"
